...
export const TransporterButton = styled.TouchableOpacity`
...
export const SearchInputContent = styled.TextInput`
  flex: 1;
`;
export const TransporterButtonDelete = styled.TouchableOpacity`
  justify-content: center;
  align-items: center;
  background-color: #f2f4f7;
  border-radius: 8px;
...
export const TransporterActions = styled.View`
  flex-direction: row;
  align-items: center;
  gap: 12px;
